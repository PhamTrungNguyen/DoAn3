...
AS
BEGIN
	SELECT P.TenPhim AS [Tên phim], CONVERT(DATE, LC.ThoiGianChieu) AS [Ngày chiếu], CONVERT(TIME(0),LC.ThoiGianChieu) AS [Giờ chiếu], COUNT(V.IDVe) AS [Số vé đã bán], SUM(TienBanVe) AS [Tiền vé]
	FROM dbo.Ve AS V, dbo.LichChieu AS LC, dbo.DinhDangPhim AS DDP, Phim AS P
	WHERE V.idLichChieu = LC.IDLichChieu AND LC.IDDinhDang = DDP.IDDinhDangPhim AND DDP.idPhim = P.IDPhim AND V.TrangThai = 1 AND P.IDPhim = @idMovie AND LC.ThoiGianChieu >= @fromDate AND LC.ThoiGianChieu <= @toDate
	GROUP BY  P.TenPhim, LC.ThoiGianChieu
END
GO
...
-------Add Phim-------
INSERT into [Phim] ([IDPhim], [TenPhim],  [ThoiLuong], [NgayKhoiChieu], [NgayKetThuc], [SanXuat], [DaoDien], [NamSX] ,[IDTheLoai]) VALUES (N'P01', N'Avengers: Cuộc Chiến Vô Cực',  150, CAST(N'2022-05-01' AS Date), CAST(N'2022-06-01' AS Date), N'Mỹ', N'Anthony Russo,  Joe Russo', 2022 , N'TL01')
INSERT into [Phim] ([IDPhim], [TenPhim],  [ThoiLuong], [NgayKhoiChieu], [NgayKetThuc], [SanXuat], [DaoDien], [NamSX] , [IDTheLoai]) VALUES (N'P02', N'Lật Mặt: 3 Chàng Khuyết',  100, CAST(N'2022-05-01' AS Date), CAST(N'2022-06-01' AS Date), N'Việt Nam', N'Lý Hải', 2022 , N'TL02')
INSERT into [Phim] ([IDPhim], [TenPhim],  [ThoiLuong], [NgayKhoiChieu], [NgayKetThuc], [SanXuat], [DaoDien], [NamSX] , [IDTheLoai]) VALUES (N'P03', N'100 Ngày Bên Em',  100, CAST(N'2022-05-01' AS Date), CAST(N'2022-06-01' AS Date), N'Việt Nam', N'Vũ Ngọc Phượng', 2022 , N'TL03')
INSERT into [Phim] ([IDPhim], [TenPhim],  [ThoiLuong], [NgayKhoiChieu], [NgayKetThuc], [SanXuat], [DaoDien], [NamSX] , [IDTheLoai]) VALUES (N'P04', N'Ngỗng Vịt Phiêu Lưu Ký', 91, CAST(N'2022-05-01' AS Date), CAST(N'2022-06-01' AS Date), N'Mỹ', N'Christopher Jenkins', 2022, N'TL04')
-------Add DinhDangPhim-------
...
-------Add NhanVien------
INSERT [dbo].[NhanVien] ([idNhanVien], [TenNV], [NgaySinhNV], [DiaChiNV], [SDTNV], [CMNDNV]) VALUES (N'NV00', N'admin', CAST(N'2018-04-22' AS Date), N'admin', N'123', 123456789)
INSERT [dbo].[NhanVien] ([idNhanVien], [TenNV], [NgaySinhNV], [DiaChiNV], [SDTNV], [CMNDNV]) VALUES (N'NV01', N'Bán Vé', CAST(N'2018-04-30' AS Date), N'banve', N'456', 14725836)
INSERT [dbo].[NhanVien] ([idNhanVien], [TenNV], [NgaySinhNV], [DiaChiNV], [SDTNV], [CMNDNV]) VALUES (N'NV02', N'Bán Vé2', CAST(N'2017-03-30' AS Date), N'banve2', N'789', 19725836)
INSERT [dbo].[NhanVien] ([idNhanVien], [TenNV], [NgaySinhNV], [DiaChiNV], [SDTNV], [CMNDNV]) VALUES (N'NV03', N'Bán Vé3', CAST(N'2016-11-17' AS Date), N'banve3', N'8910', 17725836)
-------Add KhachHang------
INSERT [dbo].[KhachHang] ([idKhachHang], [HoTenKH], [NgaySinhKH], [DiaChiKH], [SDTKH], [CMNDKH], [DiemTichLuy]) VALUES (N'KH01', N'Nguyễn Văn A', CAST(N'1998-05-03' AS Date), N'Bla Bla', N'0123456789', N'218161554', 0)
INSERT [dbo].[KhachHang] ([idKhachHang], [HoTenKH], [NgaySinhKH], [DiaChiKH], [SDTKH], [CMNDKH], [DiemTichLuy]) VALUES (N'KH02', N'Nguyễn Văn B', CAST(N'1998-02-03' AS Date), N'Bla Bla1', N'0123456789', N'218161562', 0)
INSERT [dbo].[KhachHang] ([idKhachHang], [HoTenKH], [NgaySinhKH], [DiaChiKH], [SDTKH], [CMNDKH], [DiemTichLuy]) VALUES (N'KH03', N'Nguyễn Văn C', CAST(N'1998-01-03' AS Date), N'Bla Bla2', N'0123456789', N'218161654', 0)
INSERT [dbo].[KhachHang] ([idKhachHang], [HoTenKH], [NgaySinhKH], [DiaChiKH], [SDTKH], [CMNDKH], [DiemTichLuy]) VALUES (N'KH04', N'Nguyễn Văn D', CAST(N'1998-06-03' AS Date), N'Bla Bla3', N'0123456789', N'218161659', 0)
INSERT [dbo].[KhachHang] ([idKhachHang], [HoTenKH], [NgaySinhKH], [DiaChiKH], [SDTKH], [CMNDKH], [DiemTichLuy]) VALUES (N'KH05', N'Nguyễn Văn D', CAST(N'1998-06-03' AS Date), N'Bla Bla3', N'0123456789', N'218161651', 0)
-------Add TaiKhoan-------
INSERT [dbo].[TaiKhoan] ([UserName], [Pass], [LoaiTK], [idNhanVien]) VALUES (N'admin', N'1', 1, N'NV00')-- mk hiện thị là admin
INSERT [dbo].[TaiKhoan] ([UserName], [Pass], [LoaiTK], [idNhanVien]) VALUES (N'NV01', N'2', 2, N'NV01')-- mk hiện thị là 12345
-------Ve--------
...
BEGIN
	...
	WHERE @idDinhDang = DD.IDDinhDangPhim AND DD.idPhim = P.IDPhim
...
BEGIN
	...
	WHERE LC.idPhong = @idPhong AND LC.idDinhDang = DD.IDDinhDangPhim AND DD.idPhim = P.IDPhim AND (@ThoiGianChieu >= LC.ThoiGianChieu AND @ThoiGianChieu <= DATEADD(MINUTE, P.ThoiLuong, LC.ThoiGianChieu))

	SELECT @count2 = COUNT(*)
	FROM dbo.LichChieu LC, dbo.DinhDangPhim DD, dbo.Phim P
	WHERE @idPhong = LC.idPhong AND @idDinhDang = DD.IDDinhDangPhim AND DD.idPhim = P.IDPhim AND (LC.ThoiGianChieu >= @ThoiGianChieu AND LC.ThoiGianChieu <= DATEADD(MINUTE, P.ThoiLuong, @ThoiGianChieu))
